...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1631467051ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=prak_bdl&table=tb_jabatan">`prak_bdl`.`tb_jabatan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=prak_bdl&table=tb_divisi">`prak_bdl`.`tb_divisi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=prak_bdl&table=tb_data_pegawai">`prak_bdl`.`tb_data_pegawai`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=baru&table=transactions">`baru`.`transactions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tb_data_pegawai&table=tb_data_pegawai">`tb_data_pegawai`.`tb_data_pegawai`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tb_data_pegawai&table=tb_divisi">`tb_data_pegawai`.`tb_divisi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tb_data_pegawai&table=tb_jabatan">`tb_data_pegawai`.`tb_jabatan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=prak_BDL&table=tb_divisi">`prak_BDL`.`tb_divisi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=prak_BDL&table=tb_jabatan">`prak_BDL`.`tb_jabatan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dpm_voting&table=auth_permissions">`dpm_voting`.`auth_permissions`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="28757c315e433e2b7d70534b2e2a6168">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="prak_bdl" targettable="tb_data_pegawai">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_data_pegawai`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="prak_bdl" targettable="tb_divisi">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_divisi`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="prak_bdl" targettable="tb_jabatan">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tb_jabatan`</span>
                        </div>
